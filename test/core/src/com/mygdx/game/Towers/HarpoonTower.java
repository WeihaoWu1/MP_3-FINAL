...
public class HarpoonTower extends TowerHitBox {
    ...
    private  ArrayList<Harpoon> harpoons = new ArrayList<Harpoon>();
    ...
    public ArrayList<Harpoon> getHarpoons(){
        return harpoons;
    }
    ...
    public void spawnProjectile() {
        for (Minotaur s : PlayScreen.minotaurs) {
            if (Intersector.overlaps(hitBox, s.getHitBox())){
                Harpoon harpoon = new Harpoon((float) this.getX()-40 , (float) this.getY()-40, 100, 100);
...
//        }
    ...
    public void create() {
        ...
        walkSheet = new Texture(Gdx.files.internal("harpoon_tower.png"));
