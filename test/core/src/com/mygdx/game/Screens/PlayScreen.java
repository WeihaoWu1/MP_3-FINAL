...
//        rockTowerAnimation.dispose();
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        if (currentlyFireTower) {
            firetowers.add(new FireTowerAnimation(screenX-80, 1080 - screenY-80, 150));
            ...
            rocktowers.add(new RockTowerAnimation(screenX-80, 1080 - screenY-80, 150));
            rocktowers.get(rockTowerIndex).create();
            rockTowerIndex++;
            selectedRockTower = new RockTowerAnimation(80, 0, 150);
            selectedRockTower.create();
    ...
    public boolean touchDragged(int screenX, int screenY, int pointer) {
        if (currentlyFireTower) {
            isDraggingFire = true;
            selectedFireTower.setX(Gdx.input.getX()-80);
            selectedFireTower.setY(1080 - Gdx.input.getY()-80);
            return true;
        }
        else if (currentlyRockTower){
            isDraggingRock = true;
            selectedRockTower.setX(screenX-80);
