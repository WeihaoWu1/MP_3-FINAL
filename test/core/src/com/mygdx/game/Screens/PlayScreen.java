...
//    public static ArrayList<Fire> fires = new ArrayList<Fire>();
    ...
    public void show() {
        int x = -55;
        for (int i = 0; i < 10; i++) {
            slimes.add(new Slime(x, 299, 200, 100));
            x -= 180;
...
//    }
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        if (currentlyFireTower) {
            firetowers.add(new FireTowerAnimation(screenX+500, 1080 - screenY+500, 500));
            ...
            rocktowers.add(new RockTowerAnimation(screenX+500, 1080 - screenY+500, 500));
