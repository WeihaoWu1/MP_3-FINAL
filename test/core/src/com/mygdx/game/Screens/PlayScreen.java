...
//    public static ArrayList<Fire> fires = new ArrayList<Fire>();
    ...
    public void show() {
        int x = -55;
        for (int i = 0; i < 5; i++) {
            slimes.add(new Slime(x, 299, 50, 50));
            x -= 180;
...
//    }
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        if (currentlyFireTower) {
            firetowers.add(new FireTowerAnimation(screenX+200, 1080 - screenY+200, 200));
            ...
            rocktowers.add(new RockTowerAnimation(screenX+200, 1080 - screenY+200, 200));
